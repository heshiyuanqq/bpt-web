...
;(function ($, window, undefined)
{
    ...
    */
    ...
    Grid.defaults = {
        ...
        labels: {
        	all: "全部",
            infos: " {{ctx.start}} - {{ctx.end}} ,一共  {{ctx.total}} 条",
            loading: "加载中...",
            noResults: "没有记录!",
            refresh: "刷新",
            search: "查询"
         ...
         **/
        templates: {
        	 actionButton: "<button class=\"btn btn-primary btn-icon\" style=\"height:36px;\" type=\"button\" title=\"{{ctx.text}}\">{{ctx.content}}</button>",

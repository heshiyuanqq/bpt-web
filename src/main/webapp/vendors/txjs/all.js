...
setVerifyCallBack();
loadingBox({model:"\u9A8C\u8BC1\u7801",js:"$js_path$qmverify27faad.js",oncheck:function(){
...
loadJsFileToTop(["$js_path$com/kits/qmeditor/qqmail/release/editor2918f8.js"]);
...
p=['<a href="',o,'">',a(l),'</a>'].join("");
}
else if(j)
{
var o=l;
p=['<a href="','mailto:',o,'">',a(l),'</a>'].join("");
}
else if(i)
{
if(b)
...
if(d(m))
{
p="<span style='border-bottom:1px dashed #ccc;z-index:1' t='7' onclick='return false;' data='"+l+"'>"+l+"</span>";
...
{
cacheByIframe(a&&a.defcss==false?[]:[["css","",getRes("$css_path$comm2762b5.css")],["css",getPath("style"),"skin"]],extend({className:"menu_base_if",transparent:false,destroy:false},a,{win:b,header:["<script>",getTop.toString().replace(/[\r\n]/g,""),"<\/script>",a&&a.header||""].join(""),onload:function(c){
...
loadJsFile("$js_path$qmlinkman24e6ae.js",true,e,b);
loadJsFile("$js_path$qmaddress24e6ae.js",true,e,b);
}
...
if(!b.QMPlayer)
{
loadJsFileToTop(["$js_path$qmplayer/player289cd9.js"]);
}
waitFor(function(){
return !!b.QMPlayer;
},function(c){
...
{
var b=getTop();
b.loadCssFile("$css_path$webpushtip2762b5.css",true);
...
{
var b=getTop(),a=arguments.callee;
b.loadCssFile("$css_path$login/addAccount2762b5.css",true,b.document);
...
var u=getTop(),q=this,z=a._sPopmail,B=a._sPoppwd,o=q._oDialog.S("ipt_pwd"),e=q._oDialog.S("geConfirmBtn");
if(u.attr(e,"oauth")=="true")
{
return;
}
u.attr(e,"oauth","true");
u.addClass(e,"qui_btn_BlueDisabled");
var i=q._oDialog.S("div_verifycode"),v=q._oDialog.S("verifyImage"),l=q._oDialog.S("loginData"),k=q._oDialog.S("loginCookies"),m=q._oDialog.S("loginVerify");
var h=q._oDialog.S("div_secondFactor"),s=q._oDialog.S("smsData"),r=q._oDialog.S("smsCookies"),t=q._oDialog.S("smsUserPin");
var g=q._oDialog.S("div_challenge"),d=q._oDialog.S("challengeData"),c=q._oDialog.S("challengeCookies"),n=q._oDialog.S("phoneNumber"),w=q._oDialog.S("verifySmsChallengeAnswer"),j=q._oDialog.S("emailAnswer"),f=q._oDialog.S("deviceAddress"),p=q._oDialog.S("secretAnswer"),b=q._oDialog.S("challengeTip");
var G=function(H,I){
...
else if(H=="PhoneVerificationChallenge")
{
n.style.display="";
n.value="";
...
else if(H=="UnverifiedPhoneChallenge")
{
f.style.display="";
f.value="";
...
else if(H=="SecretQuestionChallenge")
{
p.style.display="";
p.value="";
b.innerHTML='(\u8BF7\u56DE\u7B54\u5BC6\u4FDD\u95EE\u9898 \u201C<span style="color:red;">'+I+'</span>\u201D \u6765\u5B8C\u6210\u8EAB\u4EFD\u9A8C\u8BC1)';
p.focus();
}
else if(H=="RecoveryEmailChallenge")
{
j.style.display="";
j.value="";
...
u.LogKV("getinvestigate|googleoauth|fail|challengetype");
q.doRealAction(a);
}
};
q.hideWarn();
...
{
var D=["smsUserPin="+t.value,"&smsData="+s.value,"&smsCookies="+r.value].join("");
if(i.style.display!="none")
{
D=[D,"strongauthcaptcha="+m.value].join("&");
}
u.QMAjax.send("/cgi-bin/googleoauth/secondFactor",{content:D,method:"POST",onload:function(H,I){
var J=u.evalValue(I);
if(H)
{
...
else if(J.errCode=="104")
{
u.attr(e,"oauth","false");
u.rmClass(e,"qui_btn_BlueDisabled");
if(J.verifyImageUri)
{
v.setAttribute("src",decodeURIComponent(J.verifyImageUri)+"&sid="+u.getSid());
m.value="";
i.style.display="";
}
else{
...
t.focus();
s.value=J.smsData;
r.value=J.smsCookies;
q.showWarn("\u8EAB\u4EFD\u9A8C\u8BC1\u5668\u9A8C\u8BC1\u5931\u8D25\uFF0C\u8BF7\u91CD\u65B0\u8F93\u5165");
}
else if(J.reason=="checksession")
{
u.LogKV("getinvestigate|googleoauth|fail|checksession");
i.style.display="none";
...
{
var D=["Email="+z,"&Passwd="+B,"&logincaptcha="+m.value,"&loginData="+l.value,"&loginCookies="+k.value].join("");
u.QMAjax.send("/cgi-bin/googleoauth/verifyLogin",{content:D,method:"POST",onload:function(H,I){
var J=u.evalValue(I);
if(H)
{
if(!J.errCode&&J["access_token"])
...
else if(J.errCode=="105")
{
u.attr(e,"oauth","false");
u.rmClass(e,"qui_btn_BlueDisabled");
i.style.display="none";
h.style.display="none";
d.value=J.challengeData;
c.value=J.challengeCookies;
g.style.display="";
G(J.challengeType,J.secretQuestion);
}
else if(J.reason=="checksession")
{
u.attr(e,"oauth","false");
...
{
x=[d.value,"challengetype%3DVerifySmsChallenge","VerifySmsChallengeAnswer%3D"+w.value].join("%26");
y="VerifySmsChallenge";
}
else if(n.style.display!="none")
{
x=[d.value,"challengetype%3DPhoneVerificationChallenge","phoneNumber%3D"+n.value].join("%26");
y="PhoneVerificationChallenge";
}
else if(f.style.display!="none")
{
x=[d.value,"challengetype%3DUnverifiedPhoneChallenge","deviceAddress%3D"+f.value].join("%26");
y="UnverifiedPhoneChallenge";
}
else if(p.style.display!="none")
{
x=[d.value,"challengetype%3DSecretQuestionChallenge","answer%3D"+p.value].join("%26");
y="SecretQuestionChallenge";
}
else{
x=[d.value,"challengetype%3DRecoveryEmailChallenge","emailAnswer%3D"+j.value].join("%26");
y="RecoveryEmailChallenge";
}
var D=["challengeData="+x,"&challengeCookies="+c.value].join("");
u.QMAjax.send("/cgi-bin/googleoauth/challenge",{content:D,method:"POST",onload:function(H,I){
var J=u.evalValue(I);
if(H)
{
if(!J.errCode&&J["access_token"])
...
u.QMAjax.send("/cgi-bin/googleoauth",{content:D,method:"POST",onload:function(H,I){
var J=u.evalValue(I);
if(H)
{
if(!J.errCode&&J["access_token"])
...
if(!this._msVer)
{
var a=getTop().getRes("$css_path$qui_dialogPtlogin2762b5.css"),b=(/qui_dialogPtlogin(.*)\.css/.test(a)&&RegExp.$1)||"";
this._msVer=b;
}
return this._msVer;
},getDefaultCfg:function(){
...
var a={'comm2010.css':'$css_path$comm201029616a.css'};
return function(b){
var c=a[b];
return c&&getRes(c);
};

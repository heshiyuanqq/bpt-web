/**
 * Lithuanian translation for bootstrap-datetimepicker Šarūnas Gliebus
...
(function($) {
	$.fn.datetimepicker.dates['lt'] = {
		...
		months : ["Sausis", "Vasaris", "Kovas", "Balandis", "Gegužė",
				"Birželis", "Liepa", "Rugpjūtis", "Rugsėjis", "Spalis",
				"Lapkritis", "Gruodis"],
		monthsShort : ["Sau", "Vas", "Kov", "Bal", "Geg", "Bir", "Lie", "Rugp",
				"Rugs", "Spa", "Lap", "Gru"],
		today : "Šiandien",
		suffix : [],
		meridiem : [],
